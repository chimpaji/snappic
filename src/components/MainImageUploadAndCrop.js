...
export default function Body() {
	...
	return (
		<div className='relative flex items-center justify-center flex-grow select-none'>
			<div className='absolute bottom-0 right-0 flex flex-col items-end w-full p-2 border-t-2'>
			...
			<div className='absolute top-0 left-0 w-full p-2 text-sm text-gray-600 border-b-2'>
