  ...
  return (
    <div className="h-full w-full">
      <div className="flex flex-col items-center md:px-64 my-12">
        <h1 className="font-bold text-xl mb-8">Privacy Policy for Snappic</h1>
        <p className="">
          At Snappic, accessible from https://snappic.chimpaji.com, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Snappic and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in Snappic. This policy is
          ...
          of the TermsFeed Privacy Policy Generator. Consent By using our
          ...
          emails Find and prevent fraud Log Files Snappic follows a standard
          ...
          the website, and gathering demographic information. Advertising
          Partners Privacy Policies You may consult this list to find the
          Privacy Policy for each of the advertising partners of Snappic.
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Snappic, which are sent
          directly to users' browser. They automatically receive your IP address
          when this occurs. These technologies are used to measure the
          effectiveness of their advertising campaigns and/or to personalize the
          advertising content that you see on websites that you visit. Note that
          Snappic has no access to or control over these cookies that are used
          by third-party advertisers. Third Party Privacy Policies Snappic's
          ...
          like to exercise any of these rights, please contact us. GDPR Data
          Protection Rights We would like to make sure you are fully aware of
          all of your data protection rights. Every user is entitled to the
          following: The right to access – You have the right to request copies
          ...
          rights, please contact us. Children's Information Another part of our
          ...
          monitor and guide their online activity. Snappic does not knowingly
